...
const Section: React.FC<SectionProps> = ({ title, content }) => (
  <div className="bg-white shadow-lg rounded-lg p-6 border border-gray-200 mb-6 hover:shadow-xl transition-shadow">
...
const ClaimManagement: React.FC = () => {
  return (
    <div className="container mx-auto px-4 pt-24 md:px-8 lg:px-16 py-10">
      ...
      <p className="text-lg md:text-xl text-gray-800 mb-8 text-center max-w-2xl mx-auto">
